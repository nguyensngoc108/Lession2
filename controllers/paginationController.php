...
class PaginationController
{
    ...
    {
        // Get the category tree using the CategoryModel
...
// Create an instance of the PaginationController using the database connection
$paginationController = new PaginationController($conn);

// Example usage:
$category = $paginationController->viewCategory($categoryId);

$newCategoryId = $paginationController->addCategory($categoryData);

$success = $paginationController->updateCategory($categoryId, $categoryData);

$copiedCategoryId = $paginationController->copyCategory($categoryId);

$categories = $paginationController->searchCategories($keyword);

$paginatedCategories = $paginationController->getPaginatedCategories($page, $perPage);

$categoryTree = $paginationController->getCategoryTree();
